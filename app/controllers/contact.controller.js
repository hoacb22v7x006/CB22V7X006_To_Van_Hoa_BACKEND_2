...
exports.findAll = async (req, res, next) => {
    ...
    try {
        const contactService = new ContactService(MongoDB.client); // Use the variable name in lowercase
...
exports.update = async (req, res, next)=> {
    ...
    try {
        ...
        return res.send({ message: "Contact was update seccessfull" });
    } catch (error) {
        return next(
...
exports.delete = async (req, res, next)=> {
    try {
        ...
        return res.send({ message: "Contact was delete seccessfull" });
    } catch (error) {
        return next(
